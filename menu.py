...
while place_order:
    ...
    if menu_category.isdigit():
        ...
        if int(menu_category) in menu_items.keys():
            ...
            item_number = input("Type the item number you would like to order: ")
            ...
            if item_number.isdigit():
                ...
                if item_number in menu_items:
                    ...
                    print(f"{item_number} was not a valid item option.")
            else:
...
for item in order:
    ...
    item_spaces = " " * name_spaces
    price_space = " " * price_spaces

    # 10. Print the item name, price, and quantity
    print(f"{item_name}{item_spaces}| ${price:.2f}{price_space}| {quantity}")
